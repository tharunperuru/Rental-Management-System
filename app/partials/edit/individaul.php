  		...
  		<form action="" method="POST">
		  	 <div class="row">
				...
				<div class="col-md-4">
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="alternat_mobile" placeholder="Alternat Mobile" name="alternat_mobile" value="<?php echo $data['alternat_mobile']?$data['alternat_mobile']:''; ?>"required>
				  </div>
				</div>
			</div>
			...
			<div class="row">
			 ...
			 <div class="form-group">
			    ...
			    <input type="sale" class="form-control" id="sale" placeholder="Sale" name="sale" value="<?php echo $data['sale']?$data['sale']:''; ?>"required>
			  </div>
			  </div>
			  ...
			  <div class="form-group">
			    <label for="accommodation">Accommodation<sup style="color:red">*</sup></label>
			  ...
			  <div class="form-group">
			   ...
			   <div class="row">
			 	...
			 	<div class="col-md-4">
			  <div class="form-group">
			    <label for="other">Other<sup style="color:red">*</sup></label>
			    <input type="other" class="form-control" id="other" placeholder="Other" name="other" value="<?php echo $data['other']?$data['other']:''; ?>"required>
			  </div>
			  </div>
				
			  </div>			
			  <button type="submit" class="btn btn-primary" name='register_individuals' value="register_individuals" onclick="showSuccessMessage()">Submit</button>
			</form>	
			</div>			
  	</div>
	  <script>
